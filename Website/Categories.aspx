<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="Website.Categories" %>
        ...
        <asp:DataList ID="DataListSP_ByCat" runat="server" RepeatColumns="3" Width="100%" Height="100%">
                ...
                <table>
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:Button runat="server" ID="btnDau" Text="Đầu" Height="22px" Width="50px" OnClick="btnDau_Click" /></td>
                        <td>
                            <asp:Button runat="server" ID="btnTruoc" Text="Trước" Height="22px" Width="50px" OnClick="btnTruoc_Click" /></td>
                        <td>
                            <asp:TextBox ID="txtsoTrang" runat="server" Width="29px"></asp:TextBox></td>
                        <td>
                            <asp:Button runat="server" ID="btnSau" Text="Sau" Height="22px" Width="50px" OnClick="btnSau_Click" /></td>
                        <td>
                            <asp:Button runat="server" ID="btnCuoi" Text="Cuối" Height="22px" Width="50px" OnClick="btnCuoi_Click" /></td>
                    </tr>
                </table>
            <%--</form>--%>
    </div>
